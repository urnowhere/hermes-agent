...
def _exhausted_ttl(error_code: Optional[int], error_reason: Optional[str] = None) -> int:
    ...
    Concurrency-related 429s (z.ai error 1302 or messages mentioning
    concurrent requests) get a short cooldown because they are transient.
    Generic RPM/TPM rate-limit and billing/quota 429s keep the long cooldown.
    """
