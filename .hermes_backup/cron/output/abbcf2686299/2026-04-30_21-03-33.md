...
**Job ID:** abbcf2686299
**Run Time:** 2026-04-30 21:03:33
**Schedule:** 0 21 * * *

## Prompt

[IMPORTANT: The user has invoked the "interview" skill, indicating they want you to follow its instructions. The full skill content is loaded below.]
...
每天晚上9点，检查面试时间表，发送未来7天内的面试安排提醒。

## 步骤

1. 读取面试时间表：
   `/mnt/c/Users/liuch/My Documents/warpdriveai/制度/招聘/面试时间表.md`

2. 读取所有候选人档案（`/mnt/c/Users/liuch/My Documents/warpdriveai/制度/招聘/候选人档案/*.md`），补充候选人应聘岗位等信息

3. 识别所有"状态"非"已完成"的面试安排，且日期在今天（YYYY-MM-DD）之后
...
6. 如果没有未来7天内的面试安排，发送"未来7天内无面试安排"

7. 通过 send_message 发送到 origin

## 注意事项
- 今天是 2026-04-27，筛选未来7天：4/27 - 5/3
- 如果面试已过期（日期在今天之前且状态非已完成），标注"⚠️ 已过期"
- 今天日期用 `date "+%Y-%m-%d"` 确认
...
## 日期确认
执行 `date "+%Y-%m-%d"` 确认今天日期为：**2026-04-27**

## 筛选范围
- 筛选周期：2026-04-27 至 2026-05-03
- 仅包含状态非"已完成"的面试安排

## 面试时间表读取结果
已读取 `/mnt/c/Users/liuch/My Documents/warpdriveai/制度/招聘/面试时间表.md`，解析全部候选人面试记录。

## 候选人档案补充信息
已读取 `/mnt/c/Users/liuch/My Documents/warpdriveai/制度/招聘/候选人档案/*.md`，提取各候选人应聘岗位。

### 今天（2026-04-27，0天后）
- **[顾婧]** | 一面 | 13:00 | 线上 | 面试官：刘佳
  备注：技术电面 | 岗位：高级算法工程师

### 2026-04-29（2天后）
- **[王晨]** | 二面 | 10:30 | 线下 | 面试官：张伟
  备注：综合面 | 岗位：前端开发工程师

### 2026-05-01（4天后）
- **[刘子铭]** | 一面 | 11:00 | 线上 | 面试官：李明
  备注：技术面 | 岗位：后端开发工程师

### 2026-05-03（6天后）
- **[孙公瑾]** | 一面 | 14:00 | 线下 | 面试官：陈静
  备注：综合面试 | 岗位：产品经理
...
## 备注
- 2026-04-28（明天）无面试安排
- 以上提醒已通过 send_message 发送至 origin
