...
**Job ID:** abbcf2686299
**Run Time:** 2026-04-27 21:00:45
**Schedule:** 0 21 * * *

## Prompt

[SYSTEM: The user has invoked the "interview" skill, indicating they want you to follow its instructions. The full skill content is loaded below.]
...
未来7天（4/27 - 5/3）内没有待安排的面试安排。

今天的两场面试状态均为"已完成"：
- 顾婧 一面（4/27）✅
- 孙公瑾 一面（4/23）✅

候选人档案中李馨蔚状态为"待入职"，入职日为 2026-05-11，超出7天窗口。
