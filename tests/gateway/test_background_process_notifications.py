...
def test_parse_session_key_valid():
    ...
    assert result == {"profile": "main", "platform": "telegram", "chat_type": "group", "chat_id": "-100"}


def test_parse_session_key_profile_routed():
    result = _parse_session_key("agent:trader:discord:group:chan123")
    assert result == {"profile": "trader", "platform": "discord", "chat_type": "group", "chat_id": "chan123"}
...
def test_parse_session_key_with_extra_parts():
    ...
    assert result == {"profile": "main", "platform": "discord", "chat_type": "group", "chat_id": "chan123"}
...
def test_parse_session_key_with_user_id_part():
    ...
    assert result == {"profile": "main", "platform": "telegram", "chat_type": "group", "chat_id": "chat1"}
...
def test_parse_session_key_dm_with_thread():
    ...
    assert result == {"profile": "main", "platform": "telegram", "chat_type": "dm", "chat_id": "chat1", "thread_id": "topic42"}
...
def test_parse_session_key_thread_chat_type():
    ...
    assert result == {"profile": "main", "platform": "discord", "chat_type": "thread", "chat_id": "chan1", "thread_id": "thread99"}
...
def test_parse_session_key_wrong_prefix():
    ...
    # "cron" is now a valid profile name — not a prefix guard
    result = _parse_session_key("agent:cron:telegram:dm:123")
    assert result == {"profile": "cron", "platform": "telegram", "chat_type": "dm", "chat_id": "123"}
