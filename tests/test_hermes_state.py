...
class TestSchemaInit:
    ...
    def test_v11_inline_fts_migrates_to_v12_external_content(self, tmp_path):
        """Upgrade rebuilds derived FTS indexes without mutating source messages."""
        import sqlite3

        old_db = tmp_path / "v11.db"
