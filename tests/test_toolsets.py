...
class TestToolsetConsistency:
    ...
    def test_sidecar_toolset_includes_delegate_task(self):
        """Browser sidecar sessions should keep normal Hermes delegation."""
        sidecar_tools = set(TOOLSETS["hermes-sidecar"]["tools"])
        assert "delegate_task" in sidecar_tools
