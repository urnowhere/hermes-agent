...
class TestCustomProvidersValidation:
    ...
    def test_root_max_concurrent_warns_as_misplaced(self):
        """max_concurrent belongs under model or custom_providers, not root."""
        issues = validate_config_structure({"max_concurrent": 2})
        assert any("max_concurrent" in i.message for i in issues)
