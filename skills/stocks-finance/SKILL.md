...
Script path: `~/.hermes/skills/stocks-finance/scripts/stocks_client.py`
...
```
SCRIPT=~/.hermes/skills/stocks-finance/scripts/stocks_client.py
...
## Verification
```bash
python3 ~/.hermes/skills/stocks-finance/scripts/stocks_client.py quote AAPL
```
