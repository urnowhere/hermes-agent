"""Graph-backed Teams meeting, transcript, recording, and call-record helpers."""
...
from tools.teams_pipeline_models import MeetingArtifact, TeamsMeetingRef
...
async def download_transcript_text(
    ...
    *,
    ...
    try:
        ...
        raise _wrap_graph_error(
            exc,
            missing_message=f"Transcript {transcript.artifact_id} not found for meeting {meeting_ref.meeting_id}",
        ) from exc
    finally:
        try:
