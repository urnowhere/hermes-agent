"""Normalized models for the Microsoft Teams meeting pipeline."""
...
class MeetingArtifact:
    ...
    def from_dict(cls, payload: dict[str, Any]) -> "MeetingArtifact":
        return cls(
            ...
            display_name=payload.get("display_name") or payload.get("displayName") or payload.get("name"),
        ...
        return _clean_dict(
            {
                ...
                "source_artifacts": [artifact.to_dict() for artifact in self.source_artifacts] or None,
...
class TeamsMeetingPipelineJob:
    ...
    def from_dict(cls, payload: dict[str, Any]) -> "TeamsMeetingPipelineJob":
        ...
        return cls(
            ...
            summary_payload=TeamsMeetingSummaryPayload.from_dict(summary_payload) if summary_payload else None,
