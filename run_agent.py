        ...
        try:
            ...
            try:
                response = _call_llm(
                    ...
                    temperature=0.3,
                    max_tokens=5120,
                    # timeout omitted — resolved from auxiliary.flush_memories.timeout in config
                )
            except RuntimeError:
            ...
            while retry_count < max_retries:
                try:
                    ...
                    if response_invalid:
                        ...
                        if provider_name == "Unknown" and response:
                            ...
                            try:
                                ...
                                # Response object doesn't have __dict__ (some Pydantic models)
                                resp_attrs = {
                    ...
                    if (
                        ...
                        if (
                            "signature" in _err_msg_lower
                            and "thinking" in _err_msg_lower
                        ):
