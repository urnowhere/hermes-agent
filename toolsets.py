...
TOOLSETS = {
    ...
    "hermes-whatsapp-via-mcp-meta-business-api": {
        "description": "WhatsApp via external MCP (Meta Business Cloud API) toolset",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
