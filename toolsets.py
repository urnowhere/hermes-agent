...
TOOLSETS = {
    ...
    "hermes-nostr": {
        "description": "Nostr bot toolset - decentralized censorship-resistant messaging (full access)",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
