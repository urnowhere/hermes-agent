    ...
    def _init_schema(self):
        ...
        if row is None:
            ...
            if current_version < 12:
                ...
                # - Rolling back to v11 code is search-compatible because the
                #   existing external-content tables/triggers remain in place
                #   and v11 uses IF NOT EXISTS for FTS setup.
                # - Phrase queries no longer match across content/tool_name/
                #   tool_calls column boundaries. That is intentional: v11's
