...
export const zh: Translations = {
  ...
  openDesign: {
    title: "Open Design",
    description: "把管理面板连接到 Open Design 仓库，控制它的开发服务器，并把 brief 推送到工作目录。",
    statusLabel: "状态",
    healthy: "健康",
    lastStart: "上次启动",
    logPath: "日志路径",
    ...
    restarted: "Open Design 已重启",
    opened: "Open Design UI 已打开",
    connection: "连接设置",
    connectionDescription: "设置仓库路径、启动命令、健康检查 URL，以及生成 brief/产物的工作目录。",
    repoPath: "仓库路径",
    startCommand: "启动命令",
    uiUrl: "UI 地址",
    healthUrl: "健康检查地址",
    workspaceDir: "工作目录",
    artifactsDir: "产物目录",
    configSaved: "Open Design 配置已保存",
    configSaveFailed: "保存 Open Design 配置失败",
    loadFailed: "加载 Open Design 数据失败",
    briefTitle: "推送 brief",
    briefDescription: "在已配置工作目录中创建包含 brief.md、brief.json 和可选 DESIGN.md 的项目文件夹。",
    projectName: "项目名",
    skillLabel: "技能 / 模式",
    briefLabel: "Brief",
    briefPlaceholder: "描述要设计或实现的内容...",
    designSystem: "设计系统说明",
    designSystemPlaceholder: "可选：视觉规则或设计系统约束...",
    pushBrief: "推送 brief",
    pushing: "推送中...",
    briefRequired: "Brief 必填",
    briefPushed: "Brief 已推送",
    briefPushFailed: "推送 brief 失败",
    artifactsTitle: "产物",
    artifactsDescription: "来自已配置产物目录/工作目录的最近文件。",
    noArtifacts: "还没有发现产物。",
    download: "打开",
    environmentTitle: "环境变量覆盖",
    environmentDescription: "保存到此 Open Design 集成配置中的环境变量。",
    noEnv: "未配置环境变量覆盖。",
  },
