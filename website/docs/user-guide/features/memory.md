...
For deeper, persistent memory that goes beyond MEMORY.md and USER.md, Hermes ships with 9 external memory provider plugins — including Honcho, OpenViking, Mem0, Hindsight, Holographic, LanceDB, RetainDB, ByteRover, and Supermemory.
