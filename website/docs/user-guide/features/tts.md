...
tts:
  provider: "edge"              # "edge" | "elevenlabs" | "openai" | "minimax" | "mistral" | "gemini" | "xai" | "fish" | "neutts" | "kittentts" | "piper"
  ...
  fish:
    model: "s2-pro"             # Fish Audio TTS model; "s1" is also supported by the API
    reference_id: ""            # Optional Fish Audio voice/model ID
    latency: "normal"           # "normal" or other API-supported latency modes
  neutts:
    ref_audio: ''
    ref_text: ''
...
- **OpenAI, ElevenLabs, Mistral, and Fish Audio** produce Opus natively — no extra setup
...
:::tip
If you want voice bubbles without installing ffmpeg, switch to the OpenAI, ElevenLabs, Mistral, or Fish Audio provider.
:::
