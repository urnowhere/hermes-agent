...
| `HERMES_HOME_MODE` | Octal chmod mode for Hermes-owned directories, including `cron/` and cron output directories (default: `0700`; example: `0701` for web-server traversal without directory listings). File permissions remain hardened separately |
