...
- **Runs anywhere, not just your laptop** — 4 terminal backends: local, Docker, SSH, Daytona, Singularity, and Modal offer serverless persistence — your environment hibernates when idle, costing nearly nothing
