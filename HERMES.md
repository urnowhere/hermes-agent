...
| `hermes-lcm` | `~/.hermes/plugins/hermes-lcm/` | Lossless Context Management — hierarchical session compression. Current version: v0.8.0.8.0.8.0.8.0.8.0.8.0.8.0.8.0.8.0.8.0.8.0.8.0.8.0. Auto-updates Mondays 4AM via cron `f0e72a4cd297`. |
