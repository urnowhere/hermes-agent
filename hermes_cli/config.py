...
DEFAULT_CONFIG = {
    ...
    "agent": {
        ...
        # Default preset used for CLI sessions when platform_toolsets.cli is
        # not explicitly configured. Set "hermes-cli" for the full historical
        # tool schema.
        "default_cli_toolset": "hermes-lite",
