...
OPTIONAL_ENV_VARS = {
    ...
    "ZULIP_BOT_EMAIL": {
        "description": "Zulip bot email address (e.g. hermes-bot@your-org.zulipchat.com)",
    ...
    "ZULIP_ALLOWED_USERS": {
        ...
        "prompt": "Allowed Zulip users (comma-separated emails)",
        "url": None,
        "password": False,
        "category": "messaging",
    },
    "ZULIP_ALLOW_ALL_USERS": {
        "description": "Allow all Zulip users without an allowlist (true/false)",
        "prompt": "Allow all Zulip users",
        "url": None,
        "password": False,
        "category": "messaging",
    },
    "ZULIP_DEFAULT_STREAM": {
        "description": "Default Zulip stream for cron delivery and notifications",
    ...
    "ZULIP_REQUIRE_MENTION": {
        "description": "Require @mention in Zulip streams (default: true). Set to false to respond to all messages.",
    ...
    "ZULIP_FREE_RESPONSE_STREAMS": {
        "description": "Comma-separated Zulip stream names where bot responds without @mention",
        "prompt": "Free-response stream names (comma-separated)",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
    ...
    "ZULIP_CONTEXT_DEPTH": {
        "description": "Number of recent messages to fetch from a stream+topic when the bot is @mentioned. Uses Zulip's /messages API so context survives disconnects. Set to 0 to disable. (default: 0)",
        "prompt": "Context depth for @mentions (0-100)",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
