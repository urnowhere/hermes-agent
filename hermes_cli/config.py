...
_EXTRA_ENV_KEYS = frozenset({
    ...
    "LINE_ALLOWED_USERS", "LINE_HOME_CHANNEL", "LINE_HOME_CHANNEL_NAME",
    "LINE_WEBHOOK_HOST", "LINE_WEBHOOK_PORT", "LINE_WEBHOOK_PATH", "LINE_ALLOW_ALL_USERS",
...
OPTIONAL_ENV_VARS = {
    ...
    "LINE_CHANNEL_ACCESS_TOKEN": {
        "description": "LINE channel access token (long-lived) from LINE Developers Console → Messaging API tab",
    ...
    "LINE_CHANNEL_SECRET": {
        "description": "LINE channel secret from LINE Developers Console → Basic settings tab",
    ...
    "LINE_ALLOWED_USERS": {
        "description": "Comma-separated LINE user IDs allowed to use the bot",
        "prompt": "Allowed LINE user IDs (comma-separated)",
        "url": None,
        "password": False,
        "category": "messaging",
    },
    "LINE_HOME_CHANNEL": {
        "description": "LINE user or group ID for cron job results and notifications",
        "prompt": "LINE home channel (user or group ID)",
        "url": None,
        "password": False,
        "category": "messaging",
    },
    "LINE_ALLOW_ALL_USERS": {
        "description": "Allow all LINE users to interact with the bot (true/false). Default: false.",
        "prompt": "Allow all LINE users (true/false)",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
