...
_EXTRA_ENV_KEYS = frozenset({
    ...
    "LANGFUSE_SECRET_KEY",
    "LANGFUSE_BASE_URL",
    # Railway OAuth app credentials and target project/environment for
    # `hermes auth railway sync-env`.
    "HERMES_RAILWAY_CLIENT_ID",
    "HERMES_RAILWAY_CLIENT_SECRET",
    "HERMES_RAILWAY_OAUTH_CLIENT_ID",
    "HERMES_RAILWAY_OAUTH_CLIENT_SECRET",
    "RAILWAY_OAUTH_CLIENT_ID",
    "RAILWAY_OAUTH_CLIENT_SECRET",
    "HERMES_RAILWAY_PROJECT_ID",
    "HERMES_RAILWAY_ENVIRONMENT_ID",
    "RAILWAY_PROJECT_ID",
    "RAILWAY_ENVIRONMENT_ID",
    "HERMES_RAILWAY_API_BASE_URL",
    "RAILWAY_API_BASE_URL",
    "HERMES_RAILWAY_OAUTH_ISSUER",
