...
_EXTRA_ENV_KEYS = frozenset({
    ...
    "YUANBAO_APP_ID", "YUANBAO_APP_KEY", "YUANBAO_APP_SECRET", "YUANBAO_BOT_ID",
    "YUANBAO_WS_URL", "YUANBAO_API_DOMAIN", "YUANBAO_ROUTE_ENV",
    "YUANBAO_HOME_CHANNEL", "YUANBAO_HOME_CHANNEL_NAME", "YUANBAO_HOME_CHANNEL_THREAD_ID",
    "YUANBAO_DM_POLICY", "YUANBAO_DM_ALLOW_FROM", "YUANBAO_GROUP_POLICY", "YUANBAO_GROUP_ALLOW_FROM",
    "YUANBAO_ALLOWED_USERS", "YUANBAO_ALLOW_ALL_USERS",
...
OPTIONAL_ENV_VARS = {
    ...
    "YUANBAO_APP_ID": {
        "description": "Yuanbao IM Bot App ID",
        "prompt": "Yuanbao App ID",
        "category": "messaging",
    },
    "YUANBAO_APP_SECRET": {
        "description": "Yuanbao IM Bot App Secret",
        "prompt": "Yuanbao App Secret",
        "password": True,
        "category": "messaging",
    },
    "YUANBAO_BOT_ID": {
        "description": "Optional Yuanbao bot ID returned by sign-token",
        "prompt": "Yuanbao Bot ID",
        "category": "messaging",
        "advanced": True,
    },
    "YUANBAO_WS_URL": {
        "description": "Override Yuanbao WebSocket gateway URL",
        "prompt": "Yuanbao WebSocket URL",
        "category": "messaging",
        "advanced": True,
    },
    "YUANBAO_API_DOMAIN": {
        "description": "Override Yuanbao API domain",
        "prompt": "Yuanbao API Domain",
        "category": "messaging",
        "advanced": True,
    },
    "YUANBAO_ROUTE_ENV": {
        "description": "Optional Yuanbao route environment override",
        "prompt": "Yuanbao Route Env",
        "category": "messaging",
        "advanced": True,
    },
    "YUANBAO_HOME_CHANNEL": {
        "description": "Default Yuanbao chat/group for cron delivery and notifications",
    ...
    "YUANBAO_DM_POLICY": {
        "description": "Yuanbao DM policy: open, allowlist, or disabled",
        "prompt": "Yuanbao DM Policy",
        "category": "messaging",
    },
    "YUANBAO_DM_ALLOW_FROM": {
        "description": "Comma-separated Yuanbao user IDs allowed by DM allowlist policy",
        "prompt": "Yuanbao DM Allow From",
        "category": "messaging",
    },
    "YUANBAO_GROUP_POLICY": {
        "description": "Yuanbao group policy: open, allowlist, or disabled",
        "prompt": "Yuanbao Group Policy",
        "category": "messaging",
    },
    "YUANBAO_GROUP_ALLOW_FROM": {
        "description": "Comma-separated Yuanbao group IDs allowed by group allowlist policy",
        "prompt": "Yuanbao Group Allow From",
        "category": "messaging",
    },
    "IRC_SERVER": {
