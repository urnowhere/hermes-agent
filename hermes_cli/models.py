...
CANONICAL_PROVIDERS: list[ProviderEntry] = [
    ...
    ProviderEntry("zai",                 "Z.AI",                   "Z.AI (Global) — api.z.ai"),
    ProviderEntry("zai-cn",              "Zhipu AI",               "Zhipu AI (China) — open.bigmodel.cn"),
    ProviderEntry("zai-coding-global",   "Z.AI Coding Plan",       "Z.AI Coding Plan (Global) — api.z.ai"),
    ProviderEntry("zai-coding-cn",       "Zhipu AI Coding Plan",   "Zhipu AI Coding Plan (China) — open.bigmodel.cn"),
