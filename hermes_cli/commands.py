...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("steer", "Inject a message after the next tool call without interrupting", "Session",
               args_hint="<prompt>"),
    CommandDef("status", "Show agent status panel (tasks, processes, cron, sub-agents)", "Session"),
    ...
    CommandDef("sloop", "Sloop loop system: health, feedback, self-healing status", "Tools & Skills",
               cli_only=True, args_hint="[status|feedback|cleanup]",
               subcommands=("status", "feedback", "cleanup")),
