    ...
    try:
        ...
        if config_yaml_path.exists():
            ...
            if isinstance(discord_cfg, dict):
                ...
                if "free_response_auto_thread" in discord_cfg and not os.getenv("DISCORD_FREE_RESPONSE_AUTO_THREAD"):
                    os.environ["DISCORD_FREE_RESPONSE_AUTO_THREAD"] = str(discord_cfg["free_response_auto_thread"]).lower()
