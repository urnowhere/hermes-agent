...
class GatewayStreamConsumer:
    ...
    def __init__(
        ...
        self._final_delivery_attempted = False  # True when we tried to deliver the
    ...
    @property
    def final_delivery_attempted(self) -> bool:
        """True when the stream consumer attempted to deliver the final response,
        regardless of success.  When _final_response_sent is False but this is
        True, delivery failed and the gateway should retry (fixes #XXXX)."""
        return self._final_delivery_attempted
        ...
        try:
            while True:
                ...
                if got_done:
                    ...
                    # full response again.
                    self._final_delivery_attempted = True
