"""Advanced diagnostic CLI commands for formsy_memory provider."""
...
logger = logging.getLogger("formsy.memory.diagnostics")
...
def format_status_output(config, diagnostics: Optional[dict] = None) -> str:
    ...
    lines = []
    lines.append("=" * 50)
    lines.append("FormSy Memory Provider Status")
    lines.append("=" * 50)
    lines.append("Provider: formsy_memory")
...
async def doctor_command(hermes_home: Path) -> None:
    ...
    print("Running FormSy Memory Provider diagnostics...\n")
